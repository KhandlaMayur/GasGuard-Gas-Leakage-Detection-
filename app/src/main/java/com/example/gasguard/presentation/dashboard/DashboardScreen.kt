...
import com.example.gasguard.presentation.auth.AuthViewModel
        ...
        Column(
            ...
            Row(
                ...
                Column {
                    ...
                    Text(text = "Gas Level: ${device.currentGasLevel}%", style = MaterialTheme.typography.bodyMedium, fontWeight = FontWeight.SemiBold)
                    Text(text = "Threshold: ${device.threshold}%", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
                }
                
                OnlineStatusIndicator(isOnline = device.isOnline)
            }
        }
    }
}
